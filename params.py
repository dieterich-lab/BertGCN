...
def parse_args(*args):
    ...
    parser.add_argument(
        "--mixfactor", default=0.5, type=float, help="Denotes how much percentage of the GCN are taken."
    )
    ...
    parser.add_argument(
        "--testunklar", action="store_true", help="Uses the '_unklar labels as test set and rest as train set.'"
    )
    parser.add_argument(
        "--clean",
        action="store_true",
    ...
    parser.add_argument(
        "--suppressupdates", action="store_true", help="If true, updating graph features is suppressed."
    )
    parser.add_argument("--report", action="store_true", help="Report dataset statistics.")
    parser.add_argument(
        "--optimize", action="store_true", help="Use optuna library to grid search the best mixfactor."
    )
